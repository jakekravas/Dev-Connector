...
router.post("/", [auth, [
  ...
  try {
    ...
    if (profile){ //if a profile is found, this will update it
      // Update
...
router.delete("/experience/:exp_id", auth, async (req, res) => {
  try {
    ...
    // Remove specific experience object
...
router.delete("/education/:edu_id", auth, async (req, res) => {
  try {
    ...
    // Get remove index
    const removeIndex = await profile.education.map(item => item._id).indexOf(req.params.edu_id);
    // Remove specific education object
